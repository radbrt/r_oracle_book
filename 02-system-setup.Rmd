...
All examples in this book are run on the BigData Lite developer VM. This is a free virtual machine you can download from Oracle, and contains both an Oracle 12c installation, drivers, Rstudio Server, Hadoop, hive, and a whole host of other "Big data" related applications you can use to explore and learn.
